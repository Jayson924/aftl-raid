...
function initApp() {
  ...
  router.register('characters', PlayersPage, 'player'); // Requires player or admin role
...
function renderNavigation() {
  ...
  nav.innerHTML = `
    <div class="nav-container">
      <h1 class="app-title">AFTL Raid Manager <span style="font-size: 0.5em; color: #888; font-weight: normal;">v1.1.09</span></h1>
